...
import { fetchPublishedPosts, fetchUserPosts } from '../controllers/post.js';
 ...
 * /api/posts:
 *   get:
 *     summary: Fetch published posts
 *     description: Returns all posts published by their creators.
 *     tags: [Posts]
 *     security:
 *       - bearerAuth: []
 *     responses:
 ...
 */
router.get( '/', authenticateUser, fetchPublishedPosts );
